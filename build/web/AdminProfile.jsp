...
<center><form action="pricesubmit" style="border:1px solid #ccc" method='post'>
  <div class="container"> <table>
   <tr>
        <td> <label for="wheat"><b>WHEAT</b></label>
        <input type="text" placeholder="Enter Wheat Price/kg" name="wheat" required></td>
        <td> <label for="rice"><b>RICE</b></label>
        <input type="text" placeholder="Enter rice price/kg" name="rice" required></td>
    </tr>
    <tr>
         <td>
         <label for="potato"><b>POTATO</b></label>
         <input type="text" placeholder="Enter potato price/kg" name="potato" required>
         </td>
         <td>
         <label for="tomato"><b>TOMATO</b></label>
         <input type="text" placeholder="Enter tomato price/kg" name="tomato" required>
         </td>
    </tr>
    ...
    <div class="clearfix">
     <tr>
         <td><button type="submit" class="signupbtn">SUBMIT</button> 
